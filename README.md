[![Build Status](https://travis-ci.org/LL1aMaH/js-assignments.svg?branch=master)](https://travis-ci.org/LL1aMaH/js-assignments)
![Hackage-Deps](https://img.shields.io/hackage-deps/v/lens.svg)
[![Greenkeeper badge](https://badges.greenkeeper.io/LL1aMaH/js-assignments.svg)](https://greenkeeper.io/)
[![GitHub release](https://img.shields.io/github/release/LL1aMaH/js-assignments.svg)](https://github.com/LL1aMaH/js-assignments/releases/latest)
...
* Edit local README.md file and update all links (just replace all occurrences of `'LL1aMaH'` with your account name).
...
```
* Open https://github.com/LL1aMaH/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/LL1aMaH/js-assignments/builds).
